...
declare module '@polkadot/types/lookup' {
    ...
    /** @name TangleRuntimeMaxParticipants (130) */
    type TangleRuntimeMaxParticipants = Null;
    /** @name TangleRuntimeMaxSubmissionLen (131) */
    type TangleRuntimeMaxSubmissionLen = Null;
    /** @name TangleRuntimeMaxAdditionalParamsLen (132) */
    type TangleRuntimeMaxAdditionalParamsLen = Null;
    ...
    interface PalletElectionProviderMultiPhaseRawSolution extends Struct {
        readonly solution: TangleRuntimeNposSolution16;
        readonly score: SpNposElectionsElectionScore;
        readonly round: u32;
    }
    /** @name TangleRuntimeNposSolution16 (227) */
    interface TangleRuntimeNposSolution16 extends Struct {
    ...
    interface PalletSessionCall extends Enum {
        ...
        readonly asSetKeys: {
            readonly keys_: TangleRuntimeOpaqueSessionKeys;
            readonly proof: Bytes;
        } & Struct;
        readonly isPurgeKeys: boolean;
        readonly type: 'SetKeys' | 'PurgeKeys';
    }
    /** @name TangleRuntimeOpaqueSessionKeys (293) */
    interface TangleRuntimeOpaqueSessionKeys extends Struct {
    ...
    interface PalletUtilityCall extends Enum {
        ...
        readonly asDispatchAs: {
            readonly asOrigin: TangleRuntimeOriginCaller;
            readonly call: Call;
        } & Struct;
    ...
    /** @name TangleRuntimeOriginCaller (361) */
    interface TangleRuntimeOriginCaller extends Enum {
    ...
    /** @name TangleRuntimeMaxKeyLen (406) */
    type TangleRuntimeMaxKeyLen = Null;
    /** @name TangleRuntimeMaxSignatureLen (407) */
    type TangleRuntimeMaxSignatureLen = Null;
    /** @name TangleRuntimeMaxDataLen (408) */
    type TangleRuntimeMaxDataLen = Null;
    /** @name TangleRuntimeMaxProofLen (409) */
    type TangleRuntimeMaxProofLen = Null;
    ...
    interface PalletBalancesIdAmountRuntimeHoldReason extends Struct {
        readonly id: TangleRuntimeRuntimeHoldReason;
        readonly amount: u128;
    }
    /** @name TangleRuntimeRuntimeHoldReason (458) */
    interface TangleRuntimeRuntimeHoldReason extends Enum {
    ...
    interface PalletBalancesIdAmountRuntimeFreezeReason extends Struct {
        readonly id: TangleRuntimeRuntimeFreezeReason;
        readonly amount: u128;
    }
    /** @name TangleRuntimeRuntimeFreezeReason (463) */
    interface TangleRuntimeRuntimeFreezeReason extends Enum {
    ...
    /** @name PalletDemocracyReferendumInfo (494) */
    ...
    /** @name PalletDemocracyReferendumStatus (495) */
    ...
    /** @name PalletDemocracyTally (496) */
    interface PalletDemocracyTally extends Struct {
        readonly ayes: u128;
        readonly nays: u128;
        readonly turnout: u128;
    }
    /** @name PalletDemocracyVoteVoting (497) */
    ...
    /** @name PalletDemocracyDelegations (501) */
    interface PalletDemocracyDelegations extends Struct {
        readonly votes: u128;
        readonly capital: u128;
    }
    /** @name PalletDemocracyVotePriorLock (502) */
    interface PalletDemocracyVotePriorLock extends ITuple<[u64, u128]> {
    }
    /** @name PalletDemocracyError (505) */
    ...
    /** @name PalletElectionsPhragmenSeatHolder (514) */
    interface PalletElectionsPhragmenSeatHolder extends Struct {
        readonly who: AccountId32;
        readonly stake: u128;
        readonly deposit: u128;
    }
    /** @name PalletElectionsPhragmenVoter (515) */
    interface PalletElectionsPhragmenVoter extends Struct {
        readonly votes: Vec<AccountId32>;
        readonly stake: u128;
        readonly deposit: u128;
    }
    /** @name PalletElectionsPhragmenError (516) */
    ...
    /** @name PalletElectionProviderMultiPhaseReadySolution (517) */
    interface PalletElectionProviderMultiPhaseReadySolution extends Struct {
        readonly supports: Vec<ITuple<[AccountId32, SpNposElectionsSupport]>>;
        readonly score: SpNposElectionsElectionScore;
        readonly compute: PalletElectionProviderMultiPhaseElectionCompute;
    }
    /** @name PalletElectionProviderMultiPhaseRoundSnapshot (519) */
    interface PalletElectionProviderMultiPhaseRoundSnapshot extends Struct {
        readonly voters: Vec<ITuple<[AccountId32, u64, Vec<AccountId32>]>>;
        readonly targets: Vec<AccountId32>;
    }
    /** @name PalletElectionProviderMultiPhaseSignedSignedSubmission (526) */
    ...
    /** @name PalletElectionProviderMultiPhaseError (527) */
    ...
    /** @name PalletStakingStakingLedger (528) */
    ...
    /** @name PalletStakingUnlockChunk (530) */
    interface PalletStakingUnlockChunk extends Struct {
        readonly value: Compact<u128>;
        readonly era: Compact<u32>;
    }
    /** @name PalletStakingNominations (533) */
    interface PalletStakingNominations extends Struct {
        readonly targets: Vec<AccountId32>;
        readonly submittedIn: u32;
        readonly suppressed: bool;
    }
    /** @name PalletStakingActiveEraInfo (534) */
    interface PalletStakingActiveEraInfo extends Struct {
        readonly index: u32;
        readonly start: Option<u64>;
    }
    /** @name SpStakingPagedExposureMetadata (536) */
    ...
    /** @name SpStakingExposurePage (538) */
    interface SpStakingExposurePage extends Struct {
        readonly pageTotal: Compact<u128>;
        readonly others: Vec<SpStakingIndividualExposure>;
    }
    /** @name PalletStakingEraRewardPoints (539) */
    interface PalletStakingEraRewardPoints extends Struct {
        readonly total: u32;
        readonly individual: BTreeMap<AccountId32, u32>;
    }
    /** @name PalletStakingUnappliedSlash (544) */
    ...
    /** @name PalletStakingSlashingSlashingSpans (548) */
    ...
    /** @name PalletStakingSlashingSpanRecord (549) */
    interface PalletStakingSlashingSpanRecord extends Struct {
        readonly slashed: u128;
        readonly paidOut: u128;
    }
    /** @name PalletStakingPalletError (552) */
    ...
    /** @name PalletBagsListListNode (572) */
    ...
    /** @name PalletBagsListListBag (573) */
    interface PalletBagsListListBag extends Struct {
        readonly head: Option<AccountId32>;
        readonly tail: Option<AccountId32>;
    }
    /** @name PalletBagsListError (575) */
    interface PalletBagsListError extends Enum {
        readonly isList: boolean;
        readonly asList: PalletBagsListListListError;
        readonly type: 'List';
    }
    /** @name PalletBagsListListListError (576) */
    ...
    /** @name PalletNominationPoolsPoolMember (577) */
    ...
    /** @name PalletNominationPoolsBondedPoolInner (582) */
    ...
    /** @name PalletNominationPoolsCommission (583) */
    ...
    /** @name PalletNominationPoolsPoolRoles (586) */
    ...
    /** @name PalletNominationPoolsRewardPool (587) */
    ...
    /** @name PalletNominationPoolsSubPools (588) */
    ...
    /** @name PalletNominationPoolsUnbondPool (589) */
    interface PalletNominationPoolsUnbondPool extends Struct {
        readonly points: u128;
        readonly balance: u128;
    }
    /** @name PalletNominationPoolsError (594) */
    ...
    /** @name PalletNominationPoolsDefensiveError (595) */
    ...
    interface PalletSchedulerScheduled extends Struct {
        ...
        readonly maybePeriodic: Option<ITuple<[u64, u32]>>;
        readonly origin: TangleRuntimeOriginCaller;
    }
    ...
    /** @name PalletIdentityRegistration (615) */
    interface PalletIdentityRegistration extends Struct {
        readonly judgements: Vec<ITuple<[u32, PalletIdentityJudgement]>>;
        readonly deposit: u128;
        readonly info: PalletIdentityLegacyIdentityInfo;
    }
    /** @name PalletIdentityRegistrarInfo (624) */
    interface PalletIdentityRegistrarInfo extends Struct {
        readonly account: AccountId32;
        readonly fee: u128;
        readonly fields: u64;
    }
    /** @name PalletIdentityAuthorityProperties (626) */
    interface PalletIdentityAuthorityProperties extends Struct {
        readonly suffix: Bytes;
        readonly allocation: u32;
    }
    /** @name PalletIdentityError (629) */
    ...
    /** @name PalletUtilityError (630) */
    interface PalletUtilityError extends Enum {
        readonly isTooManyCalls: boolean;
        readonly type: 'TooManyCalls';
    }
    /** @name PalletMultisigMultisig (632) */
    ...
    /** @name FpRpcTransactionStatus (636) */
    ...
    /** @name EthbloomBloom (639) */
    interface EthbloomBloom extends U8aFixed {
    }
    /** @name EthereumReceiptReceiptV3 (641) */
    ...
    /** @name EthereumReceiptEip658ReceiptData (642) */
    ...
    /** @name EthereumBlock (643) */
    interface EthereumBlock extends Struct {
        readonly header: EthereumHeader;
        readonly transactions: Vec<EthereumTransactionTransactionV2>;
        readonly ommers: Vec<EthereumHeader>;
    }
    /** @name EthereumHeader (644) */
    ...
    /** @name EthereumTypesHashH64 (645) */
    interface EthereumTypesHashH64 extends U8aFixed {
    }
    /** @name PalletEthereumError (650) */
    interface PalletEthereumError extends Enum {
        readonly isInvalidSignature: boolean;
        readonly isPreLogExists: boolean;
        readonly type: 'InvalidSignature' | 'PreLogExists';
    }
    /** @name PalletEvmCodeMetadata (651) */
    interface PalletEvmCodeMetadata extends Struct {
        readonly size_: u64;
        readonly hash_: H256;
    }
    /** @name PalletEvmError (653) */
    ...
    /** @name PalletHotfixSufficientsError (654) */
    ...
    /** @name PalletAirdropClaimsError (656) */
    ...
    /** @name PalletRolesRestakingLedger (657) */
    ...
    /** @name PalletRolesUnlockChunk (663) */
    interface PalletRolesUnlockChunk extends Struct {
        readonly value: Compact<u128>;
        readonly era: Compact<u32>;
    }
    /** @name PalletRolesError (667) */
    ...
    /** @name TanglePrimitivesJobsPhaseResult (668) */
    ...
    /** @name PalletJobsModuleError (670) */
    ...
    /** @name FrameSystemExtensionsCheckNonZeroSender (675) */
    type FrameSystemExtensionsCheckNonZeroSender = Null;
    /** @name FrameSystemExtensionsCheckSpecVersion (676) */
    type FrameSystemExtensionsCheckSpecVersion = Null;
    /** @name FrameSystemExtensionsCheckTxVersion (677) */
    type FrameSystemExtensionsCheckTxVersion = Null;
    /** @name FrameSystemExtensionsCheckGenesis (678) */
    type FrameSystemExtensionsCheckGenesis = Null;
    /** @name FrameSystemExtensionsCheckNonce (681) */
    interface FrameSystemExtensionsCheckNonce extends Compact<u32> {
    }
    /** @name FrameSystemExtensionsCheckWeight (682) */
    type FrameSystemExtensionsCheckWeight = Null;
    /** @name PalletTransactionPaymentChargeTransactionPayment (683) */
    interface PalletTransactionPaymentChargeTransactionPayment extends Compact<u128> {
    }
    /** @name TangleRuntimeRuntime (685) */
    type TangleRuntimeRuntime = Null;
}
