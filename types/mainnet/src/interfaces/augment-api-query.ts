...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    babe: {
       ...
       **/
      underConstruction: AugmentedQuery<ApiType, (arg: u32) => Observable<Vec<U8aFixed>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    bagsList: {
       ...
       **/
      listBags: AugmentedQuery<ApiType, (arg: u64) => Observable<Option<PalletBagsListListBag>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
    ...
    childBounties: {
       ...
       **/
      childBounties: AugmentedQuery<ApiType, (arg1: u32, arg2: u32) => Observable<Option<PalletChildBountiesChildBounty>>, [u32, u32]> & QueryableStorageEntry<ApiType, [u32, u32]>;
      /**
       ...
       **/
      childBountyDescriptions: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<Bytes>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * The cumulative child-bounty curator fee for each parent bounty.
       **/
      childrenCuratorFees: AugmentedQuery<ApiType, (arg: u32) => Observable<u128>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Number of child bounties per parent bounty.
       * Map of parent bounty index to number of child bounties.
       **/
      parentChildBounties: AugmentedQuery<ApiType, (arg: u32) => Observable<u32>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    claims: {
      claims: AugmentedQuery<ApiType, (arg: PalletAirdropClaimsUtilsMultiAddress) => Observable<Option<u128>>, [PalletAirdropClaimsUtilsMultiAddress]> & QueryableStorageEntry<ApiType, [PalletAirdropClaimsUtilsMultiAddress]>;
      /**
       ...
       **/
      signing: AugmentedQuery<ApiType, (arg: PalletAirdropClaimsUtilsMultiAddress) => Observable<Option<PalletAirdropClaimsStatementKind>>, [PalletAirdropClaimsUtilsMultiAddress]> & QueryableStorageEntry<ApiType, [PalletAirdropClaimsUtilsMultiAddress]>;
       ...
       **/
      vesting: AugmentedQuery<ApiType, (arg: PalletAirdropClaimsUtilsMultiAddress) => Observable<Option<Vec<ITuple<[u128, u128, u64]>>>>, [PalletAirdropClaimsUtilsMultiAddress]> & QueryableStorageEntry<ApiType, [PalletAirdropClaimsUtilsMultiAddress]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    democracy: {
       ...
       * large preimages.
       **/
      metadataOf: AugmentedQuery<ApiType, (arg: PalletDemocracyMetadataOwner) => Observable<Option<H256>>, [PalletDemocracyMetadataOwner]> & QueryableStorageEntry<ApiType, [PalletDemocracyMetadataOwner]>;
      /**
    ...
    electionProviderMultiPhase: {
       ...
       **/
      signedSubmissionsMap: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<PalletElectionProviderMultiPhaseSignedSignedSubmission>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    historical: {
       ...
       **/
      historicalSessions: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<ITuple<[H256, u32]>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    imOnline: {
       ...
       **/
      authoredBlocks: AugmentedQuery<ApiType, (arg1: u32, arg2: AccountId32 | string | Uint8Array) => Observable<u32>, [u32, AccountId32]> & QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
       ...
       **/
      receivedHeartbeats: AugmentedQuery<ApiType, (arg1: u32, arg2: u32) => Observable<Option<bool>>, [u32, u32]> & QueryableStorageEntry<ApiType, [u32, u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    indices: {
       ...
       **/
      accounts: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<ITuple<[AccountId32, u128, bool]>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    jobs: {
      knownResults: AugmentedQuery<ApiType, (arg1: TanglePrimitivesRolesRoleType, arg2: u64) => Observable<Option<TanglePrimitivesJobsPhaseResult>>, [TanglePrimitivesRolesRoleType, u64]> & QueryableStorageEntry<ApiType, [TanglePrimitivesRolesRoleType, u64]>;
      /**
       * The job-id storage
       **/
      nextJobId: AugmentedQuery<ApiType, () => Observable<u64>, []> & QueryableStorageEntry<ApiType, []>;
      submittedJobs: AugmentedQuery<ApiType, (arg1: TanglePrimitivesRolesRoleType, arg2: u64) => Observable<Option<TanglePrimitivesJobsJobInfo>>, [TanglePrimitivesRolesRoleType, u64]> & QueryableStorageEntry<ApiType, [TanglePrimitivesRolesRoleType, u64]>;
      submittedJobsRole: AugmentedQuery<ApiType, (arg: u64) => Observable<Option<TanglePrimitivesRolesRoleType>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
    ...
    nominationPools: {
       ...
       **/
      bondedPools: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<PalletNominationPoolsBondedPoolInner>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      metadata: AugmentedQuery<ApiType, (arg: u32) => Observable<Bytes>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      rewardPools: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<PalletNominationPoolsRewardPool>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Groups of unbonding pools. Each group of unbonding pools belongs to a
       * bonded pool, hence the name sub-pools. Keyed by the bonded pools account.
       **/
      subPoolsStorage: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<PalletNominationPoolsSubPools>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    roles: {
       ...
       **/
      erasRestakeRewardPoints: AugmentedQuery<ApiType, (arg: u32) => Observable<PalletStakingEraRewardPoints>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    scheduler: {
       ...
       **/
      agenda: AugmentedQuery<ApiType, (arg: u64) => Observable<Vec<Option<PalletSchedulerScheduled>>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<TangleRuntimeOpaqueSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, TangleRuntimeOpaqueSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
    ...
    staking: {
       ...
       **/
      claimedRewards: AugmentedQuery<ApiType, (arg1: u32, arg2: AccountId32 | string | Uint8Array) => Observable<Vec<u32>>, [u32, AccountId32]> & QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
       * Counter for the related counted storage map
       **/
       ...
       * If reward hasn't been set or has been removed then 0 reward is returned.
       **/
      erasRewardPoints: AugmentedQuery<ApiType, (arg: u32) => Observable<PalletStakingEraRewardPoints>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      erasStakers: AugmentedQuery<ApiType, (arg1: u32, arg2: AccountId32 | string | Uint8Array) => Observable<SpStakingExposure>, [u32, AccountId32]> & QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
       ...
       * Note: Deprecated since v14. Use `EraInfo` instead to work with exposures.
       **/
      erasStakersClipped: AugmentedQuery<ApiType, (arg1: u32, arg2: AccountId32 | string | Uint8Array) => Observable<SpStakingExposure>, [u32, AccountId32]> & QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
       ...
       **/
      erasStakersOverview: AugmentedQuery<ApiType, (arg1: u32, arg2: AccountId32 | string | Uint8Array) => Observable<Option<SpStakingPagedExposureMetadata>>, [u32, AccountId32]> & QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
       ...
       **/
      erasStakersPaged: AugmentedQuery<ApiType, (arg1: u32, arg2: AccountId32 | string | Uint8Array, arg3: u32) => Observable<Option<SpStakingExposurePage>>, [u32, AccountId32, u32]> & QueryableStorageEntry<ApiType, [u32, AccountId32, u32]>;
      /**
       ...
       **/
      erasStartSessionIndex: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<u32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * The total amount staked for the last [`Config::HistoryDepth`] eras.
       * If total hasn't been set or has been removed then 0 stake is returned.
       **/
      erasTotalStake: AugmentedQuery<ApiType, (arg: u32) => Observable<u128>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       * Is it removed after [`Config::HistoryDepth`] eras.
       **/
      erasValidatorPrefs: AugmentedQuery<ApiType, (arg1: u32, arg2: AccountId32 | string | Uint8Array) => Observable<PalletStakingValidatorPrefs>, [u32, AccountId32]> & QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
       * The total validator era payout for the last [`Config::HistoryDepth`] eras.
       * 
       * Eras that haven't finished yet or has been removed doesn't have reward.
       **/
      erasValidatorReward: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<u128>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Mode of era forcing.
       **/
       ...
       **/
      nominatorSlashInEra: AugmentedQuery<ApiType, (arg1: u32, arg2: AccountId32 | string | Uint8Array) => Observable<Option<u128>>, [u32, AccountId32]> & QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
       ...
       **/
      spanSlash: AugmentedQuery<ApiType, (arg: ITuple<[AccountId32, u32]>) => Observable<PalletStakingSlashingSpanRecord>, [ITuple<[AccountId32, u32]>]> & QueryableStorageEntry<ApiType, [ITuple<[AccountId32, u32]>]>;
      /**
       * All unapplied slashes that are queued for later.
       **/
      unappliedSlashes: AugmentedQuery<ApiType, (arg: u32) => Observable<Vec<PalletStakingUnappliedSlash>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       ...
       **/
      validatorSlashInEra: AugmentedQuery<ApiType, (arg1: u32, arg2: AccountId32 | string | Uint8Array) => Observable<Option<ITuple<[Perbill, u128]>>>, [u32, AccountId32]> & QueryableStorageEntry<ApiType, [u32, AccountId32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    system: {
       ...
       **/
      blockHash: AugmentedQuery<ApiType, (arg: u64) => Observable<H256>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
    ...
    treasury: {
       ...
       **/
      spends: AugmentedQuery<ApiType, (arg: u32) => Observable<Option<PalletTreasurySpendStatus>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    txPause: {
       ...
       **/
      pausedCalls: AugmentedQuery<ApiType, (arg: ITuple<[Bytes, Bytes]>) => Observable<Option<Null>>, [ITuple<[Bytes, Bytes]>]> & QueryableStorageEntry<ApiType, [ITuple<[Bytes, Bytes]>]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
