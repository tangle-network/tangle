...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    TangleRuntimeMaxAdditionalParamsLen: TangleRuntimeMaxAdditionalParamsLen;
    TangleRuntimeMaxDataLen: TangleRuntimeMaxDataLen;
    TangleRuntimeMaxKeyLen: TangleRuntimeMaxKeyLen;
    TangleRuntimeMaxParticipants: TangleRuntimeMaxParticipants;
    TangleRuntimeMaxProofLen: TangleRuntimeMaxProofLen;
    TangleRuntimeMaxSignatureLen: TangleRuntimeMaxSignatureLen;
    TangleRuntimeMaxSubmissionLen: TangleRuntimeMaxSubmissionLen;
    TangleRuntimeNposSolution16: TangleRuntimeNposSolution16;
    TangleRuntimeOpaqueSessionKeys: TangleRuntimeOpaqueSessionKeys;
    TangleRuntimeOriginCaller: TangleRuntimeOriginCaller;
    TangleRuntimeRuntime: TangleRuntimeRuntime;
    TangleRuntimeRuntimeFreezeReason: TangleRuntimeRuntimeFreezeReason;
    TangleRuntimeRuntimeHoldReason: TangleRuntimeRuntimeHoldReason;
  } // InterfaceTypes
} // declare module
