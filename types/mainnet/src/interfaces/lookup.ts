...
export default {
   ...
   **/
  TangleRuntimeMaxParticipants: 'Null',
  /**
   * Lookup131: tangle_runtime::MaxSubmissionLen
   **/
  TangleRuntimeMaxSubmissionLen: 'Null',
  /**
   * Lookup132: tangle_runtime::MaxAdditionalParamsLen
   **/
  TangleRuntimeMaxAdditionalParamsLen: 'Null',
  /**
  ...
  PalletElectionProviderMultiPhaseRawSolution: {
    solution: 'TangleRuntimeNposSolution16',
    score: 'SpNposElectionsElectionScore',
    round: 'u32'
  },
  /**
  ...
  PalletSessionCall: {
    _enum: {
      set_keys: {
        ...
        keys_: 'TangleRuntimeOpaqueSessionKeys',
        proof: 'Bytes',
      },
      purge_keys: 'Null'
    }
  ...
  PalletUtilityCall: {
    _enum: {
      ...
      dispatch_as: {
        asOrigin: 'TangleRuntimeOriginCaller',
        call: 'Call',
      },
      force_batch: {
        calls: 'Vec<Call>',
   ...
   **/
  TangleRuntimeMaxKeyLen: 'Null',
  /**
   * Lookup407: tangle_runtime::MaxSignatureLen
   **/
  TangleRuntimeMaxSignatureLen: 'Null',
  /**
   * Lookup408: tangle_runtime::MaxDataLen
   **/
  TangleRuntimeMaxDataLen: 'Null',
  /**
   * Lookup409: tangle_runtime::MaxProofLen
   **/
  TangleRuntimeMaxProofLen: 'Null',
  /**
  ...
  PalletBalancesIdAmountRuntimeHoldReason: {
    id: 'TangleRuntimeRuntimeHoldReason',
    amount: 'u128'
  },
  /**
  ...
  PalletBalancesIdAmountRuntimeFreezeReason: {
    id: 'TangleRuntimeRuntimeFreezeReason',
    amount: 'u128'
  },
  /**
  ...
  PalletSchedulerScheduled: {
    ...
    maybePeriodic: 'Option<(u64,u32)>',
    origin: 'TangleRuntimeOriginCaller'
  },
  /**
