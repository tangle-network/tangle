...
declare module '@polkadot/api-base/types/calls' {
  interface AugmentedCalls<ApiType extends ApiTypes> {
    ...
    babeApi: {
       ...
       **/
      generateKeyOwnershipProof: AugmentedCall<ApiType, (slot: Slot, authorityId: AuthorityId | string | Uint8Array) => Observable<Option<OpaqueKeyOwnershipProof>>>;
      /**
       ...
       **/
      submitReportEquivocationUnsignedExtrinsic: AugmentedCall<ApiType, (equivocationProof: BabeEquivocationProof, keyOwnerProof: OpaqueKeyOwnershipProof | string | Uint8Array) => Observable<Option<Null>>>;
      /**
       * Generic call
       **/
      [key: string]: DecoratedCallBase<ApiType>;
    ...
    debugRuntimeApi: {
       ...
       **/
      traceBlock: AugmentedCall<ApiType, (extrinsics: Vec<Extrinsic>, knownTransactions: Vec<H256>) => Observable<Result<ITuple<[]>, DispatchError>>>;
      /**
       * Trace transaction extrinsics
       **/
      traceTransaction: AugmentedCall<ApiType, (extrinsics: Vec<Extrinsic>, transaction: EthTransaction) => Observable<Result<ITuple<[]>, DispatchError>>>;
      /**
       * Generic call
       **/
      [key: string]: DecoratedCallBase<ApiType>;
    ...
    grandpaApi: {
       ...
       **/
      generateKeyOwnershipProof: AugmentedCall<ApiType, (setId: SetId, authorityId: AuthorityId | string | Uint8Array) => Observable<Option<OpaqueKeyOwnershipProof>>>;
      /**
       ...
       * Submits an unsigned extrinsic to report an equivocation.
       **/
      submitReportEquivocationUnsignedExtrinsic: AugmentedCall<ApiType, (equivocationProof: GrandpaEquivocationProof, keyOwnerProof: OpaqueKeyOwnershipProof | string | Uint8Array) => Observable<Option<Null>>>;
      /**
       * Generic call
       **/
      [key: string]: DecoratedCallBase<ApiType>;
    ...
    metadata: {
       ...
       **/
      metadataAtVersion: AugmentedCall<ApiType, (version: u32) => Observable<Option<OpaqueMetadata>>>;
      /**
