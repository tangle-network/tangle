...
import { EthereumTransactionTransactionV2, FrameSupportPreimagesBounded, PalletAirdropClaimsStatementKind, PalletAirdropClaimsUtilsMultiAddress, PalletAirdropClaimsUtilsMultiAddressSignature, PalletBalancesAdjustmentDirection, PalletDemocracyConviction, PalletDemocracyMetadataOwner, PalletDemocracyVoteAccountVote, PalletDkgFeeInfo, PalletElectionProviderMultiPhaseRawSolution, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletElectionsPhragmenRenouncing, PalletIdentityJudgement, PalletIdentityLegacyIdentityInfo, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PalletMultisigTimepoint, PalletNominationPoolsBondExtra, PalletNominationPoolsClaimPermission, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsCommissionClaimPermission, PalletNominationPoolsConfigOpAccountId32, PalletNominationPoolsConfigOpPerbill, PalletNominationPoolsConfigOpU128, PalletNominationPoolsConfigOpU32, PalletNominationPoolsPoolState, PalletRolesProfile, PalletStakingPalletConfigOpPerbill, PalletStakingPalletConfigOpPercent, PalletStakingPalletConfigOpU128, PalletStakingPalletConfigOpU32, PalletStakingRewardDestination, PalletStakingValidatorPrefs, PalletVestingVestingInfo, PalletZksaasFeeInfo, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusGrandpaEquivocationProof, SpConsensusSlotsEquivocationProof, SpCoreVoid, SpNposElectionsElectionScore, SpNposElectionsSupport, SpRuntimeMultiSignature, SpSessionMembershipProof, SpWeightsWeightV2Weight, StagingXcmV4Asset, StagingXcmV4AssetAssetId, StagingXcmV4Location, SygmaBridgeProposal, SygmaFeeHandlerRouterFeeHandlerType, SygmaTraitsMpcAddress, TanglePrimitivesJobsJobResult, TanglePrimitivesJobsJobSubmission, TanglePrimitivesJobsV2ApprovalPrefrence, TanglePrimitivesJobsV2Field, TanglePrimitivesJobsV2OperatorPreferences, TanglePrimitivesJobsV2ServiceBlueprint, TanglePrimitivesJobsValidatorOffenceType, TanglePrimitivesMisbehaviorMisbehaviorSubmission, TanglePrimitivesRolesRoleType, TangleTestnetRuntimeOpaqueSessionKeys, TangleTestnetRuntimeOriginCaller, TangleTestnetRuntimeProxyType } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    services: {
       ...
       * See `Pallet::call`.
       **/
      call: AugmentedSubmittable<(serviceId: Compact<u64> | AnyNumber | Uint8Array, job: Compact<u8> | AnyNumber | Uint8Array, args: Vec<TanglePrimitivesJobsV2Field> | (TanglePrimitivesJobsV2Field | { None: any } | { Bool: any } | { Uint8: any } | { Int8: any } | { Uint16: any } | { Int16: any } | { Uint32: any } | { Int32: any } | { Uint64: any } | { Int64: any } | { String: any } | { Bytes: any } | { Array: any } | { List: any } | { AccountId: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Compact<u64>, Compact<u8>, Vec<TanglePrimitivesJobsV2Field>]>;
      /**
       * See `Pallet::create_blueprint`.
       **/
      createBlueprint: AugmentedSubmittable<(blueprint: TanglePrimitivesJobsV2ServiceBlueprint | { metadata?: any; jobs?: any; registrationHook?: any; registrationParams?: any; requestHook?: any; requestParams?: any; gadget?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [TanglePrimitivesJobsV2ServiceBlueprint]>;
      /**
       * See `Pallet::register`.
       **/
      register: AugmentedSubmittable<(blueprintId: Compact<u64> | AnyNumber | Uint8Array, preferences: TanglePrimitivesJobsV2OperatorPreferences | { key?: any; approval?: any } | string | Uint8Array, registrationArgs: Vec<TanglePrimitivesJobsV2Field> | (TanglePrimitivesJobsV2Field | { None: any } | { Bool: any } | { Uint8: any } | { Int8: any } | { Uint16: any } | { Int16: any } | { Uint32: any } | { Int32: any } | { Uint64: any } | { Int64: any } | { String: any } | { Bytes: any } | { Array: any } | { List: any } | { AccountId: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Compact<u64>, TanglePrimitivesJobsV2OperatorPreferences, Vec<TanglePrimitivesJobsV2Field>]>;
      /**
       * See `Pallet::reject`.
       **/
       ...
       * See `Pallet::request`.
       **/
      request: AugmentedSubmittable<(blueprintId: Compact<u64> | AnyNumber | Uint8Array, permittedCallers: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[], serviceProviders: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[], ttl: Compact<u64> | AnyNumber | Uint8Array, requestArgs: Vec<TanglePrimitivesJobsV2Field> | (TanglePrimitivesJobsV2Field | { None: any } | { Bool: any } | { Uint8: any } | { Int8: any } | { Uint16: any } | { Int16: any } | { Uint32: any } | { Int32: any } | { Uint64: any } | { Int64: any } | { String: any } | { Bytes: any } | { Array: any } | { List: any } | { AccountId: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Compact<u64>, Vec<AccountId32>, Vec<AccountId32>, Compact<u64>, Vec<TanglePrimitivesJobsV2Field>]>;
      /**
       * See `Pallet::submit_result`.
       **/
      submitResult: AugmentedSubmittable<(serviceId: Compact<u64> | AnyNumber | Uint8Array, callId: Compact<u64> | AnyNumber | Uint8Array, result: Vec<TanglePrimitivesJobsV2Field> | (TanglePrimitivesJobsV2Field | { None: any } | { Bool: any } | { Uint8: any } | { Int8: any } | { Uint16: any } | { Int16: any } | { Uint32: any } | { Int32: any } | { Uint64: any } | { Int64: any } | { String: any } | { Bytes: any } | { Array: any } | { List: any } | { AccountId: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [Compact<u64>, Compact<u64>, Vec<TanglePrimitivesJobsV2Field>]>;
      /**
       ...
       **/
      updateApprovalPreference: AugmentedSubmittable<(blueprintId: Compact<u64> | AnyNumber | Uint8Array, approvalPreference: TanglePrimitivesJobsV2ApprovalPrefrence | 'None' | 'Required' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u64>, TanglePrimitivesJobsV2ApprovalPrefrence]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
