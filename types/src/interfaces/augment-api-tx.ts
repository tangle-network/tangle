...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    claims: {
       ...
       **/
      claimSigned: AugmentedSubmittable<
        (
          dest:
            | Option<PalletAirdropClaimsUtilsMultiAddress>
            | null
    ...
    lst: {
      ...
      bondExtraOther: AugmentedSubmittable<
        ...
        [MultiAddress, u32, PalletTangleLstBondExtra]
      >
      /**
       * See [`Pallet::chill`].
       **/
      ...
      create: AugmentedSubmittable<
        ...
        [Compact<u128>, MultiAddress, MultiAddress, MultiAddress, Bytes]
      >
      /**
      ...
      createWithPoolId: AugmentedSubmittable<
        ...
        [Compact<u128>, MultiAddress, MultiAddress, MultiAddress, u32, Bytes]
      >
      /**
       * See [`Pallet::join`].
       **/
      ...
      setCommissionChangeRate: AugmentedSubmittable<
        ...
        [u32, PalletTangleLstCommissionCommissionChangeRate]
      >
      /**
      ...
      setCommissionClaimPermission: AugmentedSubmittable<
        ...
        [u32, Option<PalletTangleLstCommissionCommissionClaimPermission>]
      >
      /**
      ...
      setState: AugmentedSubmittable<
        ...
        [u32, PalletTangleLstPoolsPoolState]
      >
      /**
       * See [`Pallet::unbond`].
       **/
    ...
    multiAssetDelegation: {
       ...
       **/
      cancelDelegatorUnstake: AugmentedSubmittable<
        (
       ...
       **/
      cancelLeaveOperators: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >
      /**
       ...
       **/
      cancelOperatorUnstake: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >
      /**
       ...
       **/
      cancelWithdraw: AugmentedSubmittable<
        (
          assetId: u128 | AnyNumber | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
       ...
       **/
      executeDelegatorUnstake: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >
      /**
       ...
       **/
      executeLeaveOperators: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >
      /**
       ...
       **/
      executeOperatorUnstake: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >
      /**
       ...
       **/
      executeWithdraw: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >
      /**
       ...
       **/
      joinOperators: AugmentedSubmittable<
        (
          bondAmount: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128]
      >
      /**
       ...
       **/
      manageAssetInVault: AugmentedSubmittable<
        (
          vaultId: u128 | AnyNumber | Uint8Array,
          assetId: u128 | AnyNumber | Uint8Array,
          action:
            | PalletMultiAssetDelegationRewardsAssetAction
            | 'Add'
      ...
      operatorBondMore: AugmentedSubmittable<
        (
          additionalBond: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128]
      >
      /**
       ...
       **/
      scheduleDelegatorUnstake: AugmentedSubmittable<
        (
          operator: AccountId32 | string | Uint8Array,
          assetId: u128 | AnyNumber | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array
       ...
       **/
      scheduleLeaveOperators: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >
      /**
       ...
       **/
      scheduleOperatorUnstake: AugmentedSubmittable<
        (
          unstakeAmount: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128]
      >
      /**
       ...
       **/
      scheduleWithdraw: AugmentedSubmittable<
        (
          assetId: u128 | AnyNumber | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
      ...
      setIncentiveApyAndCap: AugmentedSubmittable<
        (
          vaultId: u128 | AnyNumber | Uint8Array,
          apy: Percent | AnyNumber | Uint8Array,
       ...
       **/
      whitelistBlueprintForRewards: AugmentedSubmittable<
        (
          blueprintId: u32 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32]
      >
      /**
    ...
    proxy: {
      ...
      addProxy: AugmentedSubmittable<
        ...
        [MultiAddress, TangleTestnetRuntimeProxyType, u64]
      >
      /**
       * See [`Pallet::announce`].
       **/
      ...
      createPure: AugmentedSubmittable<
        ...
        [TangleTestnetRuntimeProxyType, u64, u16]
      >
      /**
      ...
      killPure: AugmentedSubmittable<
        (
          ...
          proxyType:
            ...
            | Uint8Array,
          index: u16 | AnyNumber | Uint8Array,
          height: Compact<u64> | AnyNumber | Uint8Array,
      ...
      proxy: AugmentedSubmittable<
        ...
        [MultiAddress, Option<TangleTestnetRuntimeProxyType>, Call]
      >
      /**
    ...
    session: {
      ...
      setKeys: AugmentedSubmittable<
        (
          keys:
            | TangleTestnetRuntimeOpaqueSessionKeys
            | { babe?: any; grandpa?: any; imOnline?: any }
            | string
            | Uint8Array,
    ...
    sygmaAccessSegregator: {
       ...
       **/
      grantAccess: AugmentedSubmittable<
        (
          palletIndex: u8 | AnyNumber | Uint8Array,
          extrinsicName: Bytes | string | Uint8Array,
          who: AccountId32 | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u8, Bytes, AccountId32]
      >
      /**
       * Generic tx
       **/
    ...
    sygmaBasicFeeHandler: {
      ...
      setFee: AugmentedSubmittable<
        (
          domain: u8 | AnyNumber | Uint8Array,
          asset:
            | StagingXcmV4AssetAssetId
        ...
        [u8, StagingXcmV4AssetAssetId, u128]
      >
      /**
       * Generic tx
       **/
    ...
    sygmaBridge: {
      ...
      executeProposal: AugmentedSubmittable<
        ...
        [Vec<SygmaBridgeProposal>, Bytes]
      >
      /**
       * See [`Pallet::pause_all_bridges`].
       **/
      pauseAllBridges: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >
      /**
       ...
       **/
      pauseBridge: AugmentedSubmittable<
        (
          destDomainId: u8 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u8]
      >
      /**
       ...
       **/
      registerDomain: AugmentedSubmittable<
        (
          destDomainId: u8 | AnyNumber | Uint8Array,
          destChainId: U256 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u8, U256]
      >
      /**
       * See [`Pallet::retry`].
       **/
      retry: AugmentedSubmittable<
        (
          depositOnBlockHeight: u128 | AnyNumber | Uint8Array,
          destDomainId: u8 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, u8]
      >
       ...
       **/
      setMpcAddress: AugmentedSubmittable<
        (
          addr: SygmaTraitsMpcAddress | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [SygmaTraitsMpcAddress]
      >
      /**
       ...
       **/
      unpauseAllBridges: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >
      /**
       ...
       **/
      unpauseBridge: AugmentedSubmittable<
        (
          destDomainId: u8 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u8]
       ...
       **/
      unregisterDomain: AugmentedSubmittable<
        (
          destDomainId: u8 | AnyNumber | Uint8Array,
          destChainId: U256 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
    ...
    sygmaFeeHandlerRouter: {
      ...
      setFeeHandler: AugmentedSubmittable<
        ...
        [u8, StagingXcmV4AssetAssetId, SygmaFeeHandlerRouterFeeHandlerType]
      >
      /**
       * Generic tx
       **/
    ...
    sygmaPercentageFeeHandler: {
       ...
       **/
      setFeeRate: AugmentedSubmittable<
        (
          domain: u8 | AnyNumber | Uint8Array,
          asset:
            | StagingXcmV4AssetAssetId
            ...
            | string
            | Uint8Array,
          feeRateBasisPoint: u32 | AnyNumber | Uint8Array,
          feeLowerBound: u128 | AnyNumber | Uint8Array,
          feeUpperBound: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u8, StagingXcmV4AssetAssetId, u32, u128, u128]
      >
      /**
       * Generic tx
       **/
