...
import type { Architecture, Asset, AssetSecurityCommitment, AssetSecurityRequirement, ContainerGadget, FieldFieldType, Gadget, GadgetBinary, GadgetSource, GadgetSourceFetcher, GithubFetcher, ImageRegistryFetcher, JobDefinition, JobMetadata, MasterBlueprintServiceManagerRevision, MembershipModel, MembershipModelType, NativeGadget, OperatingSystem, RpcServicesWithBlueprint, Service, ServiceBlueprint, ServiceBlueprintServiceManager, ServiceMetadata, ServiceRegistrationHook, ServiceRequestHook, TestFetcher, WasmGadget, WasmRuntime } from '@tangle-network/tangle-substrate-types/services';
...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    AssetSecurityCommitment: AssetSecurityCommitment;
    AssetSecurityRequirement: AssetSecurityRequirement;
    ...
    MasterBlueprintServiceManagerRevision: MasterBlueprintServiceManagerRevision;
    ...
    MembershipModelType: MembershipModelType;
