  ...
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    lst: {
      ...
      bondedPools: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletTangleLstBondedPoolBondedPoolInner>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
      ...
      claimPermissions: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<PalletTangleLstClaimPermission>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>
      /**
       ...
       * Counter for the related counted storage map
       **/
      counterForUnbondingMembers: AugmentedQuery<
        ApiType,
        () => Observable<u32>,
        []
      > &
      ...
      rewardPools: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletTangleLstSubPoolsRewardPool>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
      ...
      subPoolsStorage: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletTangleLstSubPools>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>
      /**
       ...
       **/
      unbondingMembers: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<PalletTangleLstPoolsPoolMember>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>
      /**
    ...
    multiAssetDelegation: {
       ...
       **/
      assetLookupRewardVaults: AugmentedQuery<
        ApiType,
      ...
      atStake: AugmentedQuery<
        ...
        (
          ...
          Option<PalletMultiAssetDelegationOperatorOperatorSnapshot>
        >,
        [u32, AccountId32]
      > &
        QueryableStorageEntry<ApiType, [u32, AccountId32]>
       ...
       * blueprints.
       **/
      rewardConfigStorage: AugmentedQuery<
        ApiType,
        () => Observable<Option<PalletMultiAssetDelegationRewardsRewardConfig>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>
      /**
       * Storage for the reward vaults
       **/
      rewardVaults: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<Vec<u128>>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>
      /**
    ...
    services: {
       ...
       **/
      blueprints: AugmentedQuery<
        ApiType,
        (
          arg: u64 | AnyNumber | Uint8Array
        ) => Observable<
          Option<
            ITuple<[AccountId32, TanglePrimitivesServicesServiceBlueprint]>
          >
        >,
        [u64]
      > &
      ...
      instances: AugmentedQuery<
        ...
        (
          arg: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<TanglePrimitivesServicesService>>,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>
      /**
       ...
       **/
      jobCalls: AugmentedQuery<
        ApiType,
        (
          arg1: u64 | AnyNumber | Uint8Array,
          arg2: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<TanglePrimitivesServicesJobCall>>,
        [u64, u64]
      > &
       ...
       **/
      jobResults: AugmentedQuery<
        ApiType,
        (
          arg1: u64 | AnyNumber | Uint8Array,
          arg2: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<TanglePrimitivesServicesJobCallResult>>,
        [u64, u64]
      > &
        QueryableStorageEntry<ApiType, [u64, u64]>
      /**
       ...
       **/
      nextBlueprintId: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * The next free ID for a service Instance.
       **/
      nextInstanceId: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
       * The next free ID for a service call.
       **/
      nextJobCallId: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>
      /**
      ...
      operators: AugmentedQuery<
        ...
        (
          arg1: u64 | AnyNumber | Uint8Array,
          arg2: AccountId32 | string | Uint8Array
        ) => Observable<Option<TanglePrimitivesServicesOperatorPreferences>>,
        [u64, AccountId32]
      > &
      ...
      operatorsProfile: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<TanglePrimitivesServicesOperatorProfile>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>
      /**
       ...
       **/
      serviceRequests: AugmentedQuery<
        ApiType,
        (
          arg: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<TanglePrimitivesServicesServiceRequest>>,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>
      /**
    ...
    sygmaBasicFeeHandler: {
      ...
      assetFees: AugmentedQuery<
        ...
        [ITuple<[u8, StagingXcmV4AssetAssetId]>]
      > &
        QueryableStorageEntry<ApiType, [ITuple<[u8, StagingXcmV4AssetAssetId]>]>
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>
