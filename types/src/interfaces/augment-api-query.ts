...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    services: {
       ...
       **/
      blueprints: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<ITuple<[AccountId32, TanglePrimitivesJobsV2ServiceBlueprint]>>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
       * The Services Instances
       * Service ID -> Service
       **/
      instances: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<TanglePrimitivesJobsV2Service>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
       * The Service Job Calls
       * Service ID -> Call ID -> Job Call
       **/
      jobCalls: AugmentedQuery<ApiType, (arg1: u64 | AnyNumber | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<TanglePrimitivesJobsV2JobCall>>, [u64, u64]> & QueryableStorageEntry<ApiType, [u64, u64]>;
      /**
       * The Service Job Call Results
       * Service ID -> Call ID -> Job Call Result
       **/
      jobResults: AugmentedQuery<ApiType, (arg1: u64 | AnyNumber | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<TanglePrimitivesJobsV2JobCallResult>>, [u64, u64]> & QueryableStorageEntry<ApiType, [u64, u64]>;
      /**
       ...
       **/
      operators: AugmentedQuery<ApiType, (arg1: u64 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<TanglePrimitivesJobsV2OperatorPreferences>>, [u64, AccountId32]> & QueryableStorageEntry<ApiType, [u64, AccountId32]>;
      operatorsProfile: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<TanglePrimitivesJobsV2OperatorProfile>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       * The service requests along with their owner.
       * Request ID -> Service Request
       **/
      serviceRequests: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<TanglePrimitivesJobsV2ServiceRequest>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
