...
declare module "@polkadot/api-base/types/storage" {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    roles: {
       ...
       **/
      totalRestake: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
    ...
    services: {
      ...
      blueprints: AugmentedQuery<
        ...
        (
          ...
          Option<ITuple<[AccountId32, TanglePrimitivesJobsV2ServiceBlueprint]>>
        >,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>;
      ...
      instances: AugmentedQuery<
        ...
        (
          arg: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<TanglePrimitivesJobsV2Service>>,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>;
      /**
      ...
      jobCalls: AugmentedQuery<
        ...
        (
          ...
          arg2: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<TanglePrimitivesJobsV2JobCall>>,
        [u64, u64]
      > &
      ...
      jobResults: AugmentedQuery<
        ...
        (
          arg1: u64 | AnyNumber | Uint8Array,
          arg2: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<TanglePrimitivesJobsV2JobCallResult>>,
        [u64, u64]
      > &
        QueryableStorageEntry<ApiType, [u64, u64]>;
      /**
      ...
      serviceRequests: AugmentedQuery<
        ...
        (
          arg: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<TanglePrimitivesJobsV2ServiceRequest>>,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>;
      /**
