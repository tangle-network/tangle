...
import type { ErrorObjectOwned, ServicesTypesAsset } from '@tangle-network/tangle-substrate-types/rewards';
...
declare module '@polkadot/rpc-core/types/jsonrpc' {
  interface RpcInterface {
    ...
    rewards: {
       ...
       **/
      queryUserRewards: AugmentedRpc<(operator: AccountId | string | Uint8Array, asset: ServicesTypesAsset | { Custom: any } | { Erc20: any } | string | Uint8Array) => Observable<Result<Balance, ErrorObjectOwned>>>;
    };
    rpc: {
      /**
