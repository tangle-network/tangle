...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    services: {
       ...
       **/
      ApprovalPreferenceUpdated: AugmentedEvent<ApiType, [operator: AccountId32, blueprintId: u64, approvalPreference: TanglePrimitivesJobsV2ApprovalPrefrence], { operator: AccountId32, blueprintId: u64, approvalPreference: TanglePrimitivesJobsV2ApprovalPrefrence }>;
      /**
       ...
       **/
      JobCalled: AugmentedEvent<ApiType, [caller: AccountId32, serviceId: u64, callId: u64, job: u8, args: Vec<TanglePrimitivesJobsV2Field>], { caller: AccountId32, serviceId: u64, callId: u64, job: u8, args: Vec<TanglePrimitivesJobsV2Field> }>;
      /**
       * A job result has been submitted.
       **/
      JobResultSubmitted: AugmentedEvent<ApiType, [operator: AccountId32, serviceId: u64, callId: u64, job: u8, result: Vec<TanglePrimitivesJobsV2Field>], { operator: AccountId32, serviceId: u64, callId: u64, job: u8, result: Vec<TanglePrimitivesJobsV2Field> }>;
      /**
       * An new operator has been registered.
       **/
      Registered: AugmentedEvent<ApiType, [provider: AccountId32, blueprintId: u64, preferences: TanglePrimitivesJobsV2OperatorPreferences, registrationArgs: Vec<TanglePrimitivesJobsV2Field>], { provider: AccountId32, blueprintId: u64, preferences: TanglePrimitivesJobsV2OperatorPreferences, registrationArgs: Vec<TanglePrimitivesJobsV2Field> }>;
      /**
