...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    multiAssetDelegation: {
       ...
       **/
      AssetUpdatedInVault: AugmentedEvent<
        ApiType,
        [
          who: AccountId32,
          vaultId: u128,
       ...
       **/
      Cancelledwithdraw: AugmentedEvent<
        ApiType,
        [who: AccountId32],
        { who: AccountId32 }
      >
      ...
      Deposited: AugmentedEvent<
        ApiType,
        [who: AccountId32, amount: u128, assetId: u128],
        { who: AccountId32; amount: u128; assetId: u128 }
      >
      /**
       ...
       **/
      Executedwithdraw: AugmentedEvent<
        ApiType,
        [who: AccountId32],
        { who: AccountId32 }
      >
      ...
      IncentiveAPYAndCapSet: AugmentedEvent<
        ApiType,
        [vaultId: u128, apy: Percent, cap: u128],
        { vaultId: u128; apy: Percent; cap: u128 }
      >
      /**
      ...
      OperatorBondLessScheduled: AugmentedEvent<
        ApiType,
        [who: AccountId32, unstakeAmount: u128],
        { who: AccountId32; unstakeAmount: u128 }
      >
      /**
       ...
       **/
      Scheduledwithdraw: AugmentedEvent<
        ApiType,
        [who: AccountId32, amount: u128, assetId: u128],
        { who: AccountId32; amount: u128; assetId: u128 }
      >
    ...
    services: {
       ...
       **/
      EvmReverted: AugmentedEvent<
        ApiType,
        [from: H160, to: H160, data: Bytes, reason: Bytes],
        { from: H160; to: H160; data: Bytes; reason: Bytes }
      >
      /**
       ...
       **/
      PreRegistration: AugmentedEvent<
        ApiType,
       ...
       **/
      PriceTargetsUpdated: AugmentedEvent<
        ApiType,
        [
          operator: AccountId32,
          blueprintId: u64,
