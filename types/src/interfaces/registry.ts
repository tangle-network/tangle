...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    TanglePrimitivesServicesBlueprintManager: TanglePrimitivesServicesBlueprintManager;
