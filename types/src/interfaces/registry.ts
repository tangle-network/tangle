...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    TanglePrimitivesJobsTssDigitalSignatureType: TanglePrimitivesJobsTssDigitalSignatureType;
