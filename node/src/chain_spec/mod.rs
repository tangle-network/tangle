			...
			testnet_genesis(
				...
				vec![
					...
					(
						...
						get_nimbus_keys_from_seed("Dave"),
						get_vrf_keys_from_seed("Dave"),
						get_im_online_keys_from_seed("Dave"),
					),
					(
						get_account_id_from_seed::<sr25519::Public>("Eve"),
						get_collator_keys_from_seed("Eve"),
						get_dkg_keys_from_seed("Eve"),
						get_nimbus_keys_from_seed("Eve"),
						get_vrf_keys_from_seed("Eve"),
						get_im_online_keys_from_seed("Eve"),
					),
				],
				vec![
					get_account_id_from_seed::<sr25519::Public>("Alice"),
