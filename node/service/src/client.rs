...
///
/// As there exist multiple chains inside Tangle, like Tangle itself,
/// the Testnet, there can exist different kinds of client types. As these
...
/// A handle to a tangle client instance.
///
/// The tangle service supports multiple different runtimes (Moonbase, tangle
...
pub enum Client {
	#[cfg(feature = "tangle")]
	Tangle(Arc<crate::FullClient<tangle_mainnet_runtime::RuntimeApi, crate::TangleExecutor>>),
	#[cfg(feature = "testnet")]
	Testnet(Arc<crate::FullClient<tangle_testnet_runtime::RuntimeApi, crate::TestnetExecutor>>),
}

#[cfg(feature = "tangle")]
impl From<Arc<crate::FullClient<tangle_mainnet_runtime::RuntimeApi, crate::TangleExecutor>>>
	for Client
{
	fn from(
		client: Arc<crate::FullClient<tangle_mainnet_runtime::RuntimeApi, crate::TangleExecutor>>,
	) -> Self {
		Self::Tangle(client)
	}
}
...
#[cfg(feature = "testnet")]
impl From<Arc<crate::FullClient<tangle_testnet_runtime::RuntimeApi, crate::TestnetExecutor>>>
	for Client
{
	fn from(
		client: Arc<crate::FullClient<tangle_testnet_runtime::RuntimeApi, crate::TestnetExecutor>>,
	) -> Self {
		Self::Testnet(client)
	}
}
...
impl ClientHandle for Client {
	fn execute_with<T: ExecuteWithClient>(&self, t: T) -> T::Output {
		match self {
			#[cfg(feature = "tangle")]
			Self::Tangle(client) => T::execute_with_client::<_, _, crate::FullBackend>(t, client.clone()),
			#[cfg(feature = "testnet")]
			Self::Testnet(client) => T::execute_with_client::<_, _, crate::FullBackend>(t, client.clone()),
		}
	}
}
...
macro_rules! match_client {
	($self:ident, $method:ident($($param:ident),*)) => {
		match $self {
			#[cfg(feature = "tangle")]
			Self::Tangle(client) => client.$method($($param),*),
			#[cfg(feature = "testnet")]
