...
interface Vesting {
    ...
    function vestOther(bytes32 target) external;
    ...
    function vestedTransfer(bytes32 target, uint8 index) external;
    ...
    function mergeSchedules(uint32 schedule1Index, uint32 schedule2Index) external;
}
