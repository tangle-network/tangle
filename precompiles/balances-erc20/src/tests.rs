...
fn modifiers() {
	ExtBuilder::default()
		.with_balances(vec![(ALICE_ACCOUNT_ID.into(), 1000)])
		.build()
		.execute_with(|| {
			let mut tester =
				PrecompilesModifierTester::new(precompiles(), convert_account_id_to_h160(ALICE_ACCOUNT_ID), Precompile1);
...
// fn get_total_supply() {
// 	ExtBuilder::default()
// 		.with_balances(vec![(ALICE_ACCOUNT_ID.into(), 1000), (Bob.into(), 2500)])
// 		.build()
// 		.execute_with(|| {
// 			precompiles()
// 				.prepare_test(ALICE_ACCOUNT_ID, Precompile1, PCall::total_supply {})
...
// 			precompiles()
// 				.prepare_test(
// 					convert_account_id_to_h160(ALICE_ACCOUNT_ID),
// 					Precompile1,
// 					PCall::balance_of { owner: Address(convert_account_id_to_h160(ALICE_ACCOUNT_ID)) },
// 				)
// 				.expect_cost(0) // TODO: Test db read/write costs
// 				.expect_no_logs()
...
// 					Precompile1,
// 					PCall::allowance {
// 						owner: Address(convert_account_id_to_h160(ALICE_ACCOUNT_ID)),
...
// 	ExtBuilder::default()
// 		.with_balances(vec![(ALICE_ACCOUNT_ID.into(), 1000), (CryptoBaltathar.into(), 1000)])
// 		.build()
// 		.execute_with(|| {
// 			precompiles()
// 				.prepare_test(
...
// 					Precompile1,
// 					PCall::transfer_from {
// 						from: Address(ALICE_ACCOUNT_ID.into()),
// 						to: Address(Bob.into()),
// 						value: 400.into(),
// 					},
// 				)
...
// 			precompiles()
// 				.prepare_test(
// 					convert_account_id_to_h160(ALICE_ACCOUNT_ID), /* ALICE_ACCOUNT_ID sending transferFrom herself, no need for
// 					              * allowance. */
// 					Precompile1,
// 					PCall::transfer_from {
// 						from: Address(ALICE_ACCOUNT_ID.into()),
...
// 		.execute_with(|| {
// 			precompiles()
// 				.prepare_test(ALICE_ACCOUNT_ID, Precompile1, PCall::name {})
// 				.expect_cost(0) // TODO: Test db read/write costs
// 				.expect_no_logs()
...
// 		.execute_with(|| {
// 			precompiles()
// 				.prepare_test(ALICE_ACCOUNT_ID, Precompile1, PCall::symbol {})
// 				.expect_cost(0) // TODO: Test db read/write costs
// 				.expect_no_logs()
...
// 		.execute_with(|| {
// 			precompiles()
// 				.prepare_test(ALICE_ACCOUNT_ID, Precompile1, PCall::decimals {})
// 				.expect_cost(0) // TODO: Test db read/write costs
// 				.expect_no_logs()
...
// 					from: ALICE_ACCOUNT_ID.into(),
// 					to: convert_h160_to_account_id(Precompile1.into()),
// 					amount: 500
// 				}),
// 			));
...
// 				&RuntimeEvent::Balances(pallet_balances::Event::Transfer {
// 					from: convert_h160_to_account_id(Precompile1.into()),
// 					to: ALICE_ACCOUNT_ID.into(),
// 					amount: 500
// 				}),
// 			));
...
// 			// Check ALICE_ACCOUNT_ID balance is still 1000.
// 			precompiles()
// 				.prepare_test(
// 					convert_account_id_to_h160(ALICE_ACCOUNT_ID),
// 					Precompile1,
...
// 			// Withdraw
// 			precompiles()
// 				.prepare_test(convert_account_id_to_h160(ALICE_ACCOUNT_ID), Precompile1, PCall::withdraw { value: 500.into() })
// 				.expect_cost(1381)
// 				.expect_log(log2(
// 					Precompile1,
...
// 			// Withdraw
// 			precompiles()
// 				.prepare_test(convert_account_id_to_h160(ALICE_ACCOUNT_ID), Precompile1, PCall::withdraw { value: 1001.into() })
...
// 		.build()
// 		.execute_with(|| {
// 			let owner: H160 = convert_account_id_to_h160(ALICE_ACCOUNT_ID);
...
// 					convert_account_id_to_h160(ALICE_ACCOUNT_ID),
// 					Precompile1,
// 					PCall::eip2612_nonces { owner: Address(convert_account_id_to_h160(ALICE_ACCOUNT_ID)) },
// 				)
// 				.expect_cost(0) // TODO: Test db read/write costs
// 				.expect_no_logs()
...
// 			precompiles()
// 				.prepare_test(
// 					convert_account_id_to_h160(CHARLIE_ACCOUNT_ID), // can be anyone
// 					Precompile1,
...
// 					SELECTOR_LOG_APPROVAL,
// 					convert_account_id_to_h160(ALICE_ACCOUNT_ID),
// 					convert_account_id_to_h160(BOB_ACCOUNT_ID),
...
// 			let owner: H160 = convert_account_id_to_h160(ALICE_ACCOUNT_ID);
// 			let spender: H160 = convert_account_id_to_h160(BOB_ACCOUNT_ID);
// 			let value: U256 = 500u16.into();
...
// 					PCall::eip2612_permit {
// 						owner: Address(convert_account_id_to_h160(ALICE_ACCOUNT_ID)),
// 						spender: Address(convert_account_id_to_h160(BOB_ACCOUNT_ID)),
// 						value,
// 						deadline,
// 						v: v.serialize(),
// 						r: rs.r.b32().into(),
...
fn transfer_to_account_id() {
	ExtBuilder::default()
		...
		.build()
		.execute_with(|| {
			let bob_h256: H256 = H256::from_slice(&[2u8; 32]);
			precompiles()
				.prepare_test(
					HashedAddressMapping::<BlakeTwo256>::into_account_id(ALICE_ACCOUNT_ID),
					Precompile1,
					PCall::transfer_to_account_id { to: bob_h256, value: 400.into() },
				)
				.expect_cost(173364756) // 1 weight => 1 gas in mock
				.expect_log(log3(
					Precompile1,
			...
			precompiles()
				.prepare_test(
					convert_account_id_to_h160(ALICE_ACCOUNT_ID),
					Precompile1,
					PCall::balance_of { owner: Address(convert_account_id_to_h160(BOB_ACCOUNT_ID)) },
				)
				.expect_cost(0) // TODO: Test db read/write costs
				.expect_no_logs()
				.execute_returns(U256::from(400));
