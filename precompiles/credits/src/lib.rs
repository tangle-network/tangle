    ...
    Runtime::RuntimeCall: From<pallet_credits::Call<Runtime>>,
{
    ...
    fn claim_credits(
        ...
        let call = pallet_credits::Call::<Runtime>::claim_credits { amount_to_claim, offchain_account_id };
    ...
    fn calculate_accrued_credits(
        ...
        let accrued_amount = pallet_credits::Pallet::<Runtime>::update_reward_block_and_get_accrued_amount(
            &account_id,
            current_block,
