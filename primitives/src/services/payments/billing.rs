...
use super::types::{
    BillingCalculation, BillingTrigger, BillingSkipReason, 
    ServiceBillingState, EventLog
};
        ...
        Balance: From<u64>,
    {
        match self {
            ...
            PricingModel::Subscription { .. } => {
                if let Some(calculation) = self.calculate_subscription_billing(current_block, billing_state.last_billed) {
