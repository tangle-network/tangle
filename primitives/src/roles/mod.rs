...
impl TryFrom<u16> for RoleType {
	...
	fn try_from(value: u16) -> Result<Self, Self::Error> {
		match value {
			...
			0x0024 => Ok(RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostSecp256k1Taproot)),
			0x0025 => Ok(RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostRistretto255)),
			0x0026 => Ok(RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostEd25519)),
			0x0027 => Ok(RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostEd448)),
			// 0x0028 => Ok(RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostRedJubJub)),
...
impl From<RoleType> for u16 {
	fn from(value: RoleType) -> Self {
		match value {
			...
			RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostSecp256k1Taproot) => 0x0024,
			RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostRistretto255) => 0x0025,
			RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostEd25519) => 0x0026,
			RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostEd448) => 0x0027,
			// RoleType::Tss(ThresholdSignatureRoleType::ZcashFrostRedJubJub) => 0x0028,
