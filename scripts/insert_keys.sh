...
./target/release/tangle-standalone-node key insert --base-path ./tmp/standalone1 \
--chain ./chainspecs/arana-local.json \
--scheme Sr25519 \
...
./target/release/tangle-standalone-node key insert --base-path ./tmp/standalone2 \
--chain ./chainspecs/arana-local.json \
--scheme Sr25519 \
...
./target/release/tangle-standalone-node key insert --base-path ./tmp/standalone3 \
--chain ./chainspecs/arana-local.json \
--scheme Sr25519 \
...
./target/release/tangle-standalone-node key insert --base-path ./tmp/standalone4 \
--chain ./chainspecs/arana-local.json \
--scheme Sr25519 \
...
./target/release/tangle-standalone-node key insert --base-path ./tmp/standalone5 \
--chain ./chainspecs/arana-local.json \
--scheme Sr25519 \
