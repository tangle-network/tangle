...
#[test]
    ...
    fn cancel_leave_operator_tests() {
        new_test_ext().execute_with(|| {
            ...
            System::assert_has_event(RuntimeEvent::MultiAssetDelegation(Event::OperatorLeaveCancelled { who : 1 }));
...
#[test]
    fn operator_bond_more_success() {
        new_test_ext().execute_with(|| {
            ...
            // Bond more TNT
            assert_ok!(MultiAssetDelegation::operator_bond_more(RuntimeOrigin::signed(1), additional_bond));
            ...
            // Verify event
            System::assert_has_event(RuntimeEvent::MultiAssetDelegation(Event::OperatorBondMore { who : 1, additional_bond }));
        });
    }
    ...
    fn schedule_operator_bond_less_success() {
        new_test_ext().execute_with(|| {
            ...
            // Schedule bond less
            assert_ok!(MultiAssetDelegation::schedule_operator_bond_less(RuntimeOrigin::signed(1), bond_less_amount));
            ...
            // Verify event
            System::assert_has_event(RuntimeEvent::MultiAssetDelegation(Event::OperatorBondLessScheduled { who : 1, bond_less_amount }));
        });
    }
    ...
    fn execute_operator_bond_less_success() {
        new_test_ext().execute_with(|| {
            ...
            // Verify event
            System::assert_has_event(RuntimeEvent::MultiAssetDelegation(Event::OperatorBondLessExecuted { who : 1 }));
        });
    }
    ...
    fn cancel_operator_bond_less_success() {
        new_test_ext().execute_with(|| {
            ...
            // Verify event
            System::assert_has_event(RuntimeEvent::MultiAssetDelegation(Event::OperatorBondLessCancelled { who : 1 }));
        });
    }
    ...
    fn go_offline_success() {
        new_test_ext().execute_with(|| {
            ...
            // Verify event
            System::assert_has_event(RuntimeEvent::MultiAssetDelegation(Event::OperatorWentOffline{ who : 1 }));
        });
    }
    ...
    fn go_online_success() {
        new_test_ext().execute_with(|| {
            ...
            // Verify event
            System::assert_has_event(RuntimeEvent::MultiAssetDelegation(Event::OperatorWentOnline{ who : 1 }));
        });
    }