...
// 			assert_noop!(
// 				Lst::join(RuntimeOrigin::signed(10), 420, 123),
...
// 			assert_noop!(
// 				Lst::join(RuntimeOrigin::signed(11), 420, 1),
...
// 				assert_ok!(Lst::join(RuntimeOrigin::signed(account), 100, 1));
// 			}
...
// 			assert_noop!(
// 				Lst::join(RuntimeOrigin::signed(103), 100, 1),
...
// 			assert_ok!(Lst::create(RuntimeOrigin::signed(104), 100, 104, 104, 104));
...
// 			assert_noop!(
// 				Lst::join(RuntimeOrigin::signed(103), 100, pool_account),
// 				Error::<Runtime>::MaxPoolMembers
// 			);
// 		});
// 	}
...
// 			assert_noop!(
// 				Lst::unbond(RuntimeOrigin::signed(10), 10, 20),
// 				Error::<T>::MinimumBondNotMet
// 			);
// 		})
// 	}
