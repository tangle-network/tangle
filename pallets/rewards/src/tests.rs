...
fn test_calculate_user_score() {
    new_test_ext().execute_with(|| {
        ...
        let tnt_score = crate::functions::calculate_user_score::<Test>(Asset::<u32>::Native(0), &tnt_rewards);
        ...
        let other_score = crate::functions::calculate_user_score::<Test>(Asset::<u32>::Evm(1), &other_rewards);
